...
/** 
 * ClassName: Action107.java <br>
 * Description: 点击地图设备-进入客户端直播页<br>
 * Create by: name：liujie <br>email: jie_liu1@asdc.com.cn <br>
 * Create Time: 2017年6月23日<br>
 */
public class Action107 extends ActionFactoy{
    ...
    protected void exec() throws Exception {
        log.info("<==== push device live request ====>");
        ...
        json.put("result", "push device live request success");
        try {
            
            responseMessage.setType(Constants.T107);
