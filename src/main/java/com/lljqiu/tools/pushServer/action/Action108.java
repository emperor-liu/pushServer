...
/** 
 * ClassName: Action108.java <br>
 * Description: <br>
 * Create by: name：liujie <br>email: jie_liu1@asdc.com.cn <br>
 * Create Time: 2017年6月23日<br>
 */
public class Action108 extends ActionFactoy{

    private static Logger log = LoggerFactory.getLogger(Action108.class);
    ...
    protected void exec() throws Exception {
        log.info("<==== push device markflag request ====>");
        ...
        json.put("result", "push device markflag request success");
        try {
            
            responseMessage.setType(Constants.T108);
            ...
            log.debug("响应 device markflag请求异常" + e);
        }
